...
ilExerciseContentComparisonCronPlugin::getInstance()->includeClass('../interfaces/interface.ilExerciseContentComparisonCronLogWriter.php');
/**
 * Class ilExerciseContentComparisonCronBaseLogWriter
 */
abstract class ilExerciseContentComparisonCronBaseLogWriter implements ilExerciseContentComparisonCronLogWriter
{
